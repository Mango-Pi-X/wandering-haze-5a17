...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/wandering-haze-5a17#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/wandering-haze-5a17
```

A live public deployment of this template is available at [https://wandering-haze-5a17.templates.workers.dev](https://wandering-haze-5a17.templates.workers.dev)
